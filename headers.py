...
def help_msg(): # !help message content
    ...
    description ="!rembg - remove background from any photos using AI\n"
                ...
                "/sdxl [your_prompt] - Stabble Diffusion XL can draw anything from your text prompt\n"
                "/llama [your_prompt] - Llama is open source LLM that allows you get really good results\n"
                "/lzlv [your_prompt] - Lzlv-70b is open source model that actually doesnt have a censor\n"
